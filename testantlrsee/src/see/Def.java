// $ANTLR 3.3 Nov 30, 2010 12:45:30 Def.g 2011-07-11 00:27:32
...
public class Def extends TreeFilter {
    ...
    public final void declVarParamField() throws RecognitionException {
        ...
        try {
            ...
            id=(SeeAST)match(input,ID,FOLLOW_ID_in_declVarParamField126); if (state.failed) return ;
            // Def.g:38:54: ( . )?
            int alt3=2;
    ...
    public final void enterStruct() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,STRUCT,FOLLOW_STRUCT_in_enterStruct147); if (state.failed) return ;

            match(input, Token.DOWN, null); if (state.failed) return ;
            ID1=(SeeAST)match(input,ID,FOLLOW_ID_in_enterStruct149); if (state.failed) return ;
            // Def.g:47:18: ( . )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void exitStruct() throws RecognitionException {
        try {
            ...
            // Def.g:54:4: 'struct'
            {
            match(input,STRUCT,FOLLOW_STRUCT_in_exitStruct167); if (state.failed) return ;
            if ( state.backtracking==1 ) {
    ...
    public final void enterFunc() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,FUNC_DECL,FOLLOW_FUNC_DECL_in_enterFunc184); if (state.failed) return ;

            match(input, Token.DOWN, null); if (state.failed) return ;
            typeTree=(SeeAST)input.LT(1);
            matchAny(input); if (state.failed) return ;
            ID2=(SeeAST)match(input,ID,FOLLOW_ID_in_enterFunc190); if (state.failed) return ;
            // Def.g:60:30: ( . )+
            int cnt5=0;
            loop5:
            do {
    ...
    public final void exitFunc() throws RecognitionException {
        try {
            ...
            {
            match(input,FUNC_DECL,FOLLOW_FUNC_DECL_in_exitFunc206); if (state.failed) return ;
            if ( state.backtracking==1 ) {
              crtScope = crtScope.parent;
            }
    ...
    public final void enterBlock() throws RecognitionException {
        try {
            ...
            // Def.g:74:4: BLOCK
            {
            match(input,BLOCK,FOLLOW_BLOCK_in_enterBlock222); if (state.failed) return ;
            if ( state.backtracking==1 ) {
    ...
    public final void exitBlock() throws RecognitionException {
        try {
            ...
            // Def.g:78:4: BLOCK
            {
            match(input,BLOCK,FOLLOW_BLOCK_in_exitBlock236); if (state.failed) return ;
            if ( state.backtracking==1 ) {
              crtScope = crtScope.parent;
            }
    ...
    public final void returnStat() throws RecognitionException {
        ...
        try {
            ...
            // Def.g:84:4: RETURN
            {
            RETURN3=(SeeAST)match(input,RETURN,FOLLOW_RETURN_in_returnStat252); if (state.failed) return ;
            if ( state.backtracking==1 ) {
    ...
    public final Def.idRef_return idRef() throws RecognitionException {
        ...
        try {
            ...
            ID4=(SeeAST)match(input,ID,FOLLOW_ID_in_idRef269); if (state.failed) return retval;
            if ( state.backtracking==1 ) {
              ID4.scope = crtScope;
            }
